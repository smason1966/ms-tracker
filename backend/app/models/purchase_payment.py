...
class PurchasePayment(Base):
    ...
    points_earned: Mapped[Decimal | None] = mapped_column(Numeric(14, 4), nullable=True)
    cashback_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
    statement_credit_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
    purchase_discount_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
    effective_savings_amount: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
